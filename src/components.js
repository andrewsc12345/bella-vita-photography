...
else { navigator.clipboard.writeText(shareText).then(() => alert(“Copied! Paste this into a text or message to share with family and friends.”)).catch(() => window.open(“https://bellavitabyrebecca.com/#products”, “*blank”)); }
