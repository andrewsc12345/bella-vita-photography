...
import { SITE_CONTENT, PORTFOLIO, TESTIMONIALS, SERVICES, FAQS, GOOGLE_REVIEWS, PRODUCTS, DEFAULT_CLIENT_GALLERIES } from "./data.jsx";
import { useInView, AnimatedSection, ProgressiveImage, downloadImage, shareImage, Lightbox, ClientGalleryPage, AdminPanel } from "./components.jsx";
          ...
          {SERVICES.map((s, i) => (
            <AnimatedSection key={i} delay={i * 0.1}>
              <div className="bv-service-card" style={{ height: "100%", display: "flex", flexDirection: "column" }}
                ...
                {s.category === "Weddings" && <p style={{ fontSize: "0.72rem", color: "var(--muted)", fontWeight: 300, fontStyle: "italic", marginBottom: "20px", lineHeight: 1.6 }}>(all wedding collections include a private online gallery for sharing and download and print release)</p>}
                <div style={{ flex: 1 }}>
